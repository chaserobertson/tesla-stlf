...
Compute time-weighted temperature.
...
Apply same model to same data at 30-minute rather than 5-minute steps.

```{r}
fitdata30 <- alldata[seq(6, nrow(alldata), 6),]
wtdyear30 <- gamm(gamlwmod,  data = fitdata30)
summary(wtdyear30$gam)$r.sq
```

No difference in R^2: timestep should not be a factor in the following comparisons.
